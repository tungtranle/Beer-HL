          ...
          <div className="relative w-full max-w-md bg-white shadow-2xl flex flex-col animate-panel-in">
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
              ...
              <div className="flex items-center gap-2">
                {unreadCount > 0 && (
                  <button
                    onClick={() => markAllRead()}
                    className="text-xs text-amber-600 hover:text-amber-800 font-medium px-2 py-1 rounded hover:bg-amber-50 transition"
                  >
                    Đọc hết
                  </button>
                )}
            ...
            <div className="border-t border-gray-100 px-5 py-3">
              <button
                ...
                className="w-full text-center text-sm text-amber-600 hover:text-amber-800 font-medium py-1.5 rounded-lg hover:bg-amber-50 transition"
              >
