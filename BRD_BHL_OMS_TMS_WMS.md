...
**Thay đổi v3.7:** Thêm Section 14D — AI Intelligence Layer: 6 User Stories (US-AI-01..06), `internal/ai/` package architecture, Migration 040 (`ai_insights` table + `npp_risk_signals` view), 5 API endpoints mới, extend Python :8090 với 2 ML endpoints. $0 infra mới (Gemini free 1,500 req/ngày + Groq fallback). DEC-AI-01.
...
14D. [AI INTELLIGENCE LAYER](#14d-ai-intelligence-layer)
...
# 14D. AI INTELLIGENCE LAYER

> **Phiên bản:** 1.0 — 24/04/2026  
> **Nguyên tắc:** Zero infra mới. $0/tháng. Provider-agnostic (swap Gemini → Claude khi có revenue).  
> **Kiến trúc:** `internal/ai/` package trong Go + extend Python :8090 + Free-tier APIs.  
> **Quyết định:** DEC-AI-01.

## 14D.1 Tổng quan

AI Intelligence Layer không phải module riêng lẻ — là **tầng tăng cường** xuyên suốt OMS, TMS, WMS, Control Tower, giúp người dùng ra quyết định nhanh hơn và chính xác hơn thay vì chỉ xem số.
...
- AC#4: Endpoint `GET /v1/customers/:id/risk-score` public trong auth flow accountant
- AC#5: Score xuất hiện trong danh sách duyệt pending approvals + màn hình chi tiết NPP
